...
import com.krishnas.KrishnasProjectTesting.pages.GoogleSearchResultsPage;
import com.krishnas.KrishnasProjectTesting.pages.SamplePageFactory;
...
public class SampleSuiteITest extends AbstractSuite<SamplePageFactory> {
  ...
  public void we_should_be_able_to_return_new_pages_from_pages() {
    ...
    System.out.println(searchPage.getClass().getName());
    ;
  }
